# -*- coding: utf-8 -*-
#
# array_split documentation build configuration file, created by
# sphinx-quickstart on Sat Oct 1 20:11:11 2016.
#
...
conf_dir = os.path.split(__file__)[0]
# General information about the project.
project = u'array_split'
copyright = \
    open(
        os.path.join(conf_dir, "..", "..", "array_split", "copyright.txt"), "rt"
...
htmlhelp_basename = 'array_split_doc'
...
latex_documents = [
    (master_doc, 'array_split.tex', u'array_split Documentation',
     u'Shane J. Latham', 'manual'),
]
...
man_pages = [
    (master_doc, 'array_split', u'array_split Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'array_split', u'array_split Documentation',
     author, 'Shane J. Latham', 'Multi-dimensional array decomposition.',
     'Miscellaneous'),
]
...
# Autosummary
# -----------------------------------------------------------------------------
autosummary_generate = glob.glob(
    "*.rst") + glob.glob("reference/*.rst") + glob.glob("examples/*.rst")
